  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://i.ibb.co/TxSCwf8B/temp.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "Zᴀʜɪᴅ Kɪɴɢ 👑",
            body: config.DESCRIPTION || "MOST POPULAR",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://i.ibb.co/TxSCwf8B/temp.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/923044154575",
