...
├── 🎨 *POPULAR LOGOS*
│ ╭─〔🎨〕 *comic*
│ ╰─➤ Usage: .logo comic [text]
│ ╭─〔🎨〕 *dragon*
│ ╰─➤ Usage: .logo dragon [text]
│ ╭─〔🎨〕 *naruto*
│ ╰─➤ Usage: .logo naruto [text]
│ ╭─〔🎨〕 *thor*
│ ╰─➤ Usage: .logo thor [text]
│ ╭─〔🎨〕 *america*
│ ╰─➤ Usage: .logo america [text]

├── ⚡ *NEON & EFFECT*
│ ╭─〔⚡〕 *neon*
│ ╰─➤ Usage: .logo neon [text]
│ ╭─〔⚡〕 *galaxy*
│ ╰─➤ Usage: .logo galaxy [text]
│ ╭─〔⚡〕 *glitch*
│ ╰─➤ Usage: .logo glitch [text]

├── 🌿 *NATURE STYLE*
│ ╭─〔🌿〕 *cloud*
│ ╰─➤ Usage: .logo cloud [text]
│ ╭─〔🌿〕 *sand*
│ ╰─➤ Usage: .logo sand [text]
│ ╭─〔🌿〕 *fog*
│ ╰─➤ Usage: .logo fog [text]
│ ╭─〔🌿〕 *greenbrush*
│ ╰─➤ Usage: .logo greenbrush [text]

├── 🪵 *MATERIAL STYLE*
│ ╭─〔🪵〕 *gold*
│ ╰─➤ Usage: .logo gold [text]
│ ╭─〔🪵〕 *silver*
│ ╰─➤ Usage: .logo silver [text]
│ ╭─〔🪵〕 *wood*
│ ╰─➤ Usage: .logo wood [text]

├── 🌟 *SPECIAL STYLE*
│ ╭─〔🌟〕 *paper*
│ ╰─➤ Usage: .logo paper [text]
│ ╭─〔🌟〕 *wetglass*
│ ╰─➤ Usage: .logo wetglass [text]
╚══════════════════════╝
